 ...
 * @author zeno
 */
public class J0028_IsSymmetric_1 {
...
// 👍 91 👎 0
  ...
  public static void main(String[] args) {
    Solution solution = new J0028_IsSymmetric_1().new Solution();
...
//leetcode submit region begin(Prohibit modification and deletion)
  ...
  class Solution {
    ...
    public boolean isSymmetric(TreeNode root) {
      return isSymmetric0(root, mirror(root));
    }
    ...
    private boolean isSymmetric0(TreeNode root, TreeNode mirror) {
      ...
      return isSymmetric0(root.left, mirror.left) && isSymmetric0(root.right, mirror.right);
    }

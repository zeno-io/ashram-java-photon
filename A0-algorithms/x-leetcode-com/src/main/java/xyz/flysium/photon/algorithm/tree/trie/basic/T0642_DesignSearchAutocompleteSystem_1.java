 ...
 * @author zeno
 */
public class T0642_DesignSearchAutocompleteSystem_1 {
...
// 👍 59 👎 0
  ...
  // 执行用时：142 ms, 在所有 Java 提交中击败了97.30% 的用户
  ...
  class AutocompleteSystem {
    ...
    private List<String> search(String sentence) {
      ...
      for (int i = 0; i < curr.hot.size(); i++) {
        ans.add(curr.hot.get(i).sentence);
      }
      return ans;
    }

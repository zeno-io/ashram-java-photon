...
/**
 * Handles all the requests for data. It receives a {@link FullHttpRequest}, which has been
 * converted by a {@link InboundHttp2ToHttpAdapter} before it arrived here. For further details,
 * check {@link Http2OrHttpHandler} where the pipeline is setup.
 */
public class Http2RequestHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
  ...
  private void handleImage(String x, String y, ChannelHandlerContext ctx, String streamId,
    int latency,
